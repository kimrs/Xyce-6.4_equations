...
// ---------------------
//
// Revision Number: $Revision: 1.203 $
//
// Revision Date  : $Date: 2015/04/24 20:25:43 $
//
...
/* EDIT KIM */
public:
  EquationStrings * dFdx_Strings; /* EDIT KIM */
  EquationStrings * dQdx_Strings; /* EDIT KIM */
  EquationStrings * F_Strings; /* EDIT KIM */
  EquationStrings * Q_Strings; /* EDIT KIM */
  EquationStrings * B_Strings; /* EDIT KIM */
  void print_strings(Linear::Matrix &matrix, EquationStrings * strings, std::string name); /* EDIT KIM */
  void print_strings(Linear::MultiVector &matrix, EquationStrings * strings, std::string name); /* EDIT KIM */
/* DONE KIM */
